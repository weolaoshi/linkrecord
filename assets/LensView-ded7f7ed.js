...
`])),rt),Ie=S(za||(za=C([`
  ...
  `,`
  `,`
`])),Nu,Iu,pe,It,Pu,Ou,Au,Ru,$u,Mu,Fu,qu,xu),$m=S(Ya||(Ya=C([`
  ...
  `,`
  `,`
`])),Nu,Iu,pe,It,Pu,Ou,Au,Ru,$u,Mu,Fu,qu,xu),Pe=S(Ja||(Ja=C([`
...
`])),Dw,Nw),Pw=S(No||(No=C([`
  ...
  `,`
  `,`
`])),dt,pt),Ow=function(e,n,r){return e()},Aw=A(Iw),Rw=A(Pw);function $w(t){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Ow;return{HasTxHashBeenIndexed:function(r,a){return e(function(i){return t.rawRequest(Aw,r,E(E({},a),i))},"HasTxHashBeenIndexed","query")},BroadcastProtocolCall:function(r,a){return e(function(i){return t.rawRequest(Rw,r,E(E({},a),i))},"BroadcastProtocolCall","mutation")}}}function Mw(t){return t.__typename==="TransactionIndexedResult"}var Fw=function(t){un(n,t);var e=ln(n);function n(){var r;ie(this,n);for(var a=arguments.length,i=new Array(a),o=0;o<a;o++)i[o]=arguments[o];return r=e.call.apply(e,[this].concat(i)),Ue(je(r),"name","TransactionPollingError"),Ue(je(r),"message","Max attempts exceeded"),r}return se(n)}(ct(Error)),qw=function(){function t(e,n){ie(this,t);var r=new De(e.environment.gqlEndpoint);this.sdk=$w(r),this.authentication=n}return se(t,[{key:"broadcast",value:function(){var e=y(d().mark(function r(a){var i=this;return d().wrap(function(s){for(;;)switch(s.prev=s.next){case 0:return s.abrupt("return",Z(this.authentication,function(){var u=y(d().mark(function l(c){var f;return d().wrap(function(h){for(;;)switch(h.prev=h.next){case 0:return h.next=2,i.sdk.BroadcastProtocolCall({request:a},c);case 2:return f=h.sent,h.abrupt("return",f.data.result);case 4:case"end":return h.stop()}},l)}));return function(l){return u.apply(this,arguments)}}()));case 1:case"end":return s.stop()}},r,this)}));function n(r){return e.apply(this,arguments)}return n}()},{key:"wasIndexed",value:function(){var e=y(d().mark(function r(a){var i=this;return d().wrap(function(s){for(;;)switch(s.prev=s.next){case 0:return s.abrupt("return",Z(this.authentication,function(){var u=y(d().mark(function l(c){var f;return d().wrap(function(h){for(;;)switch(h.prev=h.next){case 0:return h.next=2,i.sdk.HasTxHashBeenIndexed({request:{txId:a}},c);case 2:return f=h.sent,h.abrupt("return",f.data.result);case 4:case"end":return h.stop()}},l)}));return function(l){return u.apply(this,arguments)}}()));case 1:case"end":return s.stop()}},r,this)}));function n(r){return e.apply(this,arguments)}return n}()},{key:"waitForIsIndexed",value:function(){var e=y(d().mark(function r(a){var i=this;return d().wrap(function(s){for(;;)switch(s.prev=s.next){case 0:return s.abrupt("return",Su({fn:function(){return i.wasIndexed(a)},validate:function(l){if(l.isSuccess()){var c=l.value;if(Mw(c))return c.indexed}return!0},onMaxAttempts:function(){return new Fw}}));case 1:case"end":return s.stop()}},r)}));function n(r){return e.apply(this,arguments)}return n}()}]),t}(),xw=function(){function t(e){ie(this,t),this._authentication=new km(e),this.config=e}return se(t,[{key:"authentication",get:function(){return this._authentication}},{key:"explore",get:function(){return new Bm(this.config,this._authentication)}},{key:"feed",get:function(){return new tv(this.config,this._authentication)}},{key:"modules",get:function(){return new mv(this.config,this._authentication)}},{key:"nfts",get:function(){return new Mv(this.config,this._authentication)}},{key:"nonces",get:function(){return new jv(this.config,this._authentication)}},{key:"notifications",get:function(){return new Qv(this.config,this._authentication)}},{key:"profile",get:function(){return new Kg(this.config,this._authentication)}},{key:"proxyAction",get:function(){return new fy(this.config,this._authentication)}},{key:"publication",get:function(){return new Yy(this.config,this._authentication)}},{key:"reactions",get:function(){return new iw(this.config,this._authentication)}},{key:"revenue",get:function(){return new hw(this.config,this._authentication)}},{key:"search",get:function(){return new bw(this.config,this._authentication)}},{key:"stats",get:function(){return new Cw(this.config)}},{key:"transaction",get:function(){return new qw(this.config,this._authentication)}}]),t}(),Fr=function(){function t(e,n){ie(this,t),this.name=e,this.url=n}return se(t,[{key:"gqlEndpoint",get:function(){return this.url}}]),t}(),Lw=new Fr("production","https://api.lens.dev");new Fr("development","https://api-mumbai.lens.dev");new Fr("sandbox","https://api-sandbox-mumbai.lens.dev");const Cr=new xw({environment:Lw});async function fn(t,e){let n=await Cr.publication.fetchAll({profileId:t,publicationTypes:e,limit:1});return n.items.length>0?n.items[0].createdAt:"-"}const jw=async t=>{const e=await Cr.search.profiles({query:t,limit:1});let n,r,a,i,o,s,u,l,c,f,p,h="link";if(e.items.length>0){const v=e.items[0];n=v.stats.totalFollowers,r=v.stats.totalFollowing,a=v.stats.totalPosts;const T=await Cr.profile.stats({handle:v.handle},[]);return i=T==null?void 0:T.totalComments,o=T==null?void 0:T.totalMirrors,s=T==null?void 0:T.totalPublications,u=T==null?void 0:T.totalCollects,[l,c,f,p]=await Promise.all([fn(v.id,[Mt.Post]),fn(v.id,[Mt.Comment]),fn(v.id,[Mt.Mirror]),fn(v.id,null)]),{total_followers:n,total_following:r,total_posts:a,total_comments:i,total_mirrors:o,total_publications:s,total_collects:u,last_post_datetime:l,last_comment_datetime:c,last_mirror_datetime:f,last_tx_datetime:p,link:h,coming:"开发中"}}else return{}},Io=Vu("lens",jw),Gw=Gu({__name:"LensView",setup(t){Io();const e=[{title:"#",align:"center",key:"#",width:ue.no,header_style:{backgroundColor:M.color1,fontSize:ae.size1},cell_style:{backgroundColor:M.color1}},{title:"账号",align:"center",header_style:{backgroundColor:M.color1,fontSize:ae.size1},children:[{title:"Profile ID",align:"left",key:"key",width:ue.alias,header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1}},{title:"别名",align:"left",key:"_alias",width:ue.alias,custom:!0,header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1}}]},{title:"交互",align:"center",header_style:{backgroundColor:M.color2,fontSize:ae.size1},children:[{title:"最后",align:"center",type:"datetime",key:"last_tx_datetime",width:ue.datetime,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:{backgroundColor:M.color2}},{title:"发帖",align:"center",type:"datetime",key:"last_post_datetime",width:ue.datetime,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:{backgroundColor:M.color2}},{title:"评论",align:"center",type:"datetime",key:"last_comment_datetime",width:ue.datetime,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:{backgroundColor:M.color2}},{title:"转发",align:"center",type:"datetime",key:"last_mirror_datetime",width:ue.datetime,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:{backgroundColor:M.color2}}]},{title:"SnapShot投票",align:"center",header_style:{backgroundColor:M.color1,fontSize:ae.size1},children:[{title:"Lens-已投",align:"center",key:"coming",width:ue.tx+50,sort:!0,header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1}},{title:"Lens-可投",align:"center",key:"coming",width:ue.tx+50,sort:!0,header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1}},{title:"AAVE-已投",align:"center",key:"coming",sort:!0,width:ue.tx+50,header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1}},{title:"AAVE-可投",align:"center",key:"coming",width:ue.tx+50,sort:!0,header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1}}]},{title:"统计",align:"center",header_style:{backgroundColor:M.color2,fontSize:ae.size1},children:[{title:"粉丝",align:"center",key:"total_followers",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_followers==0?{backgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}},{title:"关注",align:"center",key:"total_following",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_following==0?{bbackgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}},{title:"收藏",align:"center",key:"total_collects",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_collects==0?{backgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}},{title:"帖子",align:"center",key:"total_posts",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_posts==0?{backgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}},{title:"评论",align:"center",key:"total_comments",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_comments==0?{backgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}},{title:"转发",align:"center",key:"total_mirrors",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_mirrors==0?{backgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}},{title:"发表",align:"center",key:"total_publications",width:ue.tx,sort:!0,header_style:{backgroundColor:M.color2,fontSize:ae.size2},cell_style:function(n,r){try{return r&&r.total_publications==0?{backgroundColor:M.color2,color:M.color2}:{backgroundColor:M.color2}}catch{return{backgroundColor:M.color2}}}}]},{title:"第3方分析",align:"center",header_style:{backgroundColor:M.color1,fontSize:ae.size1},children:[{title:"lenskit.xyz",align:"center",key:"link",width:ue.link,url:"https://profile.lenskit.xyz/{key}",header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1,textDecoration:"underline"}},{title:"lenscan.xyz",align:"center",key:"link",width:ue.link,url:"https://lenscan.io/profile/{key}",header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1,textDecoration:"underline"}},{title:"dune统计",align:"center",key:"link",width:ue.link,url:"https://dune.com/cortadocasa/lensprotocol",header_style:{backgroundColor:M.color1,fontSize:ae.size2},cell_style:{backgroundColor:M.color1,textDecoration:"underline"}}]}];return(n,r)=>(Wu(),Hu(Bu,{columns:e,store:Zu(Io)(),"key-label":"Profile ID","page-size":10},null,8,["store"]))}});export{Gw as default};
