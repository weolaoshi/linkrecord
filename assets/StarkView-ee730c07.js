import{m as y,_ as T}from"./store-2e181aa4.js";import{a as C}from"./axios-4a70c6fc.js";import{a as F,d as v,c as w,u as I,o as z}from"./index-579aa7e2.js";import{g as t,b as o,a as l}from"./global-9c3e8356.js";async function G(r){let s=0,c,e;const n="https://starkscan.stellate.sh/",a={authority:"starkscan.stellate.sh",accept:"application/json","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","content-type":"application/json"},_={query:`query TransactionsTableQuery(
  $first: Int!
  $after: String
...
`,variables:{input:{contract_address:r}}},n=await C.post(s,e,{headers:c}),a=n.data.data.contract.eth_balance.balance_display,_=n.data.data.contract.starknet_id?n.data.data.contract.starknet_id.domain:"null",d=F(new Date(n.data.data.contract.deployed_at_timestamp*1e3));return{eth_balance:parseFloat(a).toFixed(3),stark_id:_==="null"?"无":_,create_time:d.format("YYYY-MM-DD HH:mm:ss")}}async function E(r){const s="https://starkscan.stellate.sh/",c={authority:"starkscan.stellate.sh",accept:"application/json","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","content-type":"application/json"},e={query:`query ERC20TransferEventsTableQuery(
  $first: Int!
  $after: String
