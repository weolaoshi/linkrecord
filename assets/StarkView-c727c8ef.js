import{m as T,R as F}from"./store-18fc4c92.js";import{a as k}from"./axios-4a70c6fc.js";import{a as v,d as w,c as I,u as z,o as G}from"./index-625cd097.js";import{g as t,b as o,a as l}from"./global-7368f992.js";let h="https://starkscan.stellate.sh/";async function E(r){let s=0,c,e;const n=h,a={authority:"starkscan.stellate.sh",accept:"application/json","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","content-type":"application/json"},_={query:`query TransactionsTableQuery(
  $first: Int!
  $after: String
...
`,variables:{input:{contract_address:r}}},n=await k.post(s,e,{headers:c}),a=n.data.data.contract.eth_balance.balance_display,_=n.data.data.contract.starknet_id?n.data.data.contract.starknet_id.domain:"null",d=v(new Date(n.data.data.contract.deployed_at_timestamp*1e3));return{eth_balance:parseFloat(a).toFixed(3),stark_id:_==="null"?"":_,create_time:d.format("YYYY-MM-DD HH:mm:ss")}}async function P(r){const s=h,c={authority:"starkscan.stellate.sh",accept:"application/json","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","content-type":"application/json"},e={query:`query ERC20TransferEventsTableQuery(
  $first: Int!
  $after: String
